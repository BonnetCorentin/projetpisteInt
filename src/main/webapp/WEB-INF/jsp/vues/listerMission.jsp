		...
		<div class="container">
			...
			<table class="table table-hover">
				...
				<c:forEach items="${mesMissions}" var="item">
					<tr>
						<td>${item.wording}</td>
						<td><a class="btn btn-primary" href="/action/${item.id}/getActions" role="button"><span
								class="glyphicon glyphicon-pushpin"></span> Actions</a>
							<%
								if (session.getAttribute("role").equals("admin")) {
							%>
								<a class="btn btn-info" href="/mission/modifierMission/${item.id}" role="button"><span
								class="glyphicon glyphicon-pencil"></span> Modifier</a>
								<a class="btn btn-danger" href="/mission/supprimerMission/${item.id}" role="button"><span
