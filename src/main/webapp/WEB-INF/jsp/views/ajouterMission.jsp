...
<div class="bg-success bg-gradient p-5 text-center" style="height: 80%;">
    <h1 class="text-white pb-3"><i class="fas fa-plus"></i> Ajouter une mission</h1>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="card col-4">
                <div class="card-body">
                    <h2 class="card-title"><i class="fas fa-gamepad"></i>  Nouvelle mission</h2>
                    <form method="POST" action="insererMission">
                        <fieldset>
